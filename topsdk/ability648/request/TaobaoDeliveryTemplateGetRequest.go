...
func (s *TaobaoDeliveryTemplateGetRequest) SetTemplateIds(v []string) *TaobaoDeliveryTemplateGetRequest {
    s.TemplateIds = &v
    return s
}
func (s *TaobaoDeliveryTemplateGetRequest) SetFields(v []string) *TaobaoDeliveryTemplateGetRequest {
    s.Fields = &v
    return s
}

func (req *TaobaoDeliveryTemplateGetRequest) ToMap() map[string]interface{} {
    paramMap := make(map[string]interface{})
    if(req.TemplateIds != nil) {
        paramMap["template_ids"] = util.ConvertBasicList(*req.TemplateIds)
    }
    if(req.Fields != nil) {
...
func (req *TaobaoDeliveryTemplateGetRequest) ToFileMap() map[string]interface{} {
