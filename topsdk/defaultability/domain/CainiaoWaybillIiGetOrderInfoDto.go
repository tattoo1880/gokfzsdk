...
type CainiaoWaybillIiGetOrderInfoDto struct {
    /*
...
func (s *CainiaoWaybillIiGetOrderInfoDto) SetOrderChannelsType(v string) *CainiaoWaybillIiGetOrderInfoDto {
    s.OrderChannelsType = &v
    return s
}
func (s *CainiaoWaybillIiGetOrderInfoDto) SetTradeOrderList(v []string) *CainiaoWaybillIiGetOrderInfoDto {
    s.TradeOrderList = &v
    return s
}
func (s *CainiaoWaybillIiGetOrderInfoDto) SetOutTradeOrderList(v []string) *CainiaoWaybillIiGetOrderInfoDto {
    s.OutTradeOrderList = &v
    return s
}
func (s *CainiaoWaybillIiGetOrderInfoDto) SetOutTradeSubOrderList(v []string) *CainiaoWaybillIiGetOrderInfoDto {
    s.OutTradeSubOrderList = &v
    return s
}
