...
type TaobaoRefundGetRefund struct {
    ...
    /*
        退款单类型，"1"代表百亿超级半托管     */
    YpdsRefundType  *string `json:"ypds_refund_type,omitempty" `

    /*
        消费者发起退款原因     */
    YpdsRefundReason  *string `json:"ypds_refund_reason,omitempty" `

    /*
        退款货款金额，退款比例*货款总额     */
    YpdsRefundSupplyFee  *string `json:"ypds_refund_supply_fee,omitempty" `
...
func (s *TaobaoRefundGetRefund) SetNewSku(v string) *TaobaoRefundGetRefund {
    s.NewSku = &v
    return s
}
func (s *TaobaoRefundGetRefund) SetRealReceiverOpenId(v string) *TaobaoRefundGetRefund {
    s.RealReceiverOpenId = &v
    return s
}
func (s *TaobaoRefundGetRefund) SetRealReceiverDisplayNick(v string) *TaobaoRefundGetRefund {
    s.RealReceiverDisplayNick = &v
    return s
}
func (s *TaobaoRefundGetRefund) SetYpdsRefundType(v string) *TaobaoRefundGetRefund {
    s.YpdsRefundType = &v
    return s
}
func (s *TaobaoRefundGetRefund) SetYpdsRefundReason(v string) *TaobaoRefundGetRefund {
    s.YpdsRefundReason = &v
    return s
}
func (s *TaobaoRefundGetRefund) SetYpdsRefundSupplyFee(v string) *TaobaoRefundGetRefund {
    s.YpdsRefundSupplyFee = &v
    return s
}
